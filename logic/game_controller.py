...
class GameController:
    ...
    def spawn_placement(self, row, column, team):
        self.game_state.add_spawn(row, column, team)
        
    def create_cell_in_pos(self, row, column, team, level, life):
        self.game_state.create_cell_in_board(row, column, team, level, life)
